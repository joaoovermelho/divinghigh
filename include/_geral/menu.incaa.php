<?php include 'include/functions.db.php'?>
                    ...
                    <div class="main-menu">
                        <nav id="mobile-menu">
                            <ul>
                                ...
                                <li class="position-static menu-item-has-children"><a href="shop.html">Shop</a>
                                    <ul class="mega_menu" data-background="./assets/img/mega-menu/product.jpg">
                                        <li>
                                ...
                                <li><a class="d-none d-xl-block" href="index.html">
                                        <img class="pl-50 pr-50" src="./assets/img/logo/logoDH-2.png" alt="">
                                    </a></li>
                                    <li class="menu-item-has-children"><a href="blog.html">Blog</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="noticias.php">Blog no sidebar</a></li>
                                        </ul>
                                    </li>
